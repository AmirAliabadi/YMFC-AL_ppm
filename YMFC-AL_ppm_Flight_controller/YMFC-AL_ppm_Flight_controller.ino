...
void loop(){
  ...
  angle_pitch_acc -= 0.0; // -0.73; // (-0.90); // 0.0;                   //Accelerometer calibration value for pitch.
  angle_roll_acc  -= 0.0; // -0.20; // (-0.05); // 0.0;                   //Accelerometer calibration value for roll.
  //Serial.print( angle_pitch_acc );Serial.print( "\t" ); Serial.println( angle_roll_acc );
  ...
  //Serial.print( pitch_level_adjust );Serial.print( "\t" ); Serial.println( roll_level_adjust );    
